...
public class Launcher {
    ...
    private static final Pattern authorizedClassNames = Pattern.compile("Day(?<problemNumber>\\d+Part[1-2])");
    ...
    private static DayAndPart getDayAndPart(Class<?> clazz) {
        ...
        String[] split = problemNumber.split("Part");
